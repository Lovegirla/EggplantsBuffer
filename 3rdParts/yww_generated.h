...
#ifndef FLATBUFFERS_GENERATED_YWW_MYGAME_SAMPLE_H_
#define FLATBUFFERS_GENERATED_YWW_MYGAME_SAMPLE_H_
...
struct YWW FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  typedef YWWBuilder Builder;
...
template<> inline const MyGame::Sample::Weapon *YWW::equipped_as<MyGame::Sample::Weapon>() const {
...
struct YWWBuilder {
  ...
  void add_pos(const MyGame::Sample::Vec3 *pos) {
    fbb_.AddStruct(YWW::VT_POS, pos);
  }
  void add_mana(int16_t mana) {
    fbb_.AddElement<int16_t>(YWW::VT_MANA, mana, 150);
  }
  void add_hp(int16_t hp) {
    fbb_.AddElement<int16_t>(YWW::VT_HP, hp, 100);
  }
  void add_name(::flatbuffers::Offset<::flatbuffers::String> name) {
    fbb_.AddOffset(YWW::VT_NAME, name);
  }
  void add_inventory(::flatbuffers::Offset<::flatbuffers::Vector<uint8_t>> inventory) {
    fbb_.AddOffset(YWW::VT_INVENTORY, inventory);
  }
  void add_color(MyGame::Sample::Color color) {
    fbb_.AddElement<int8_t>(YWW::VT_COLOR, static_cast<int8_t>(color), 2);
  }
  void add_weapons(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<MyGame::Sample::Weapon>>> weapons) {
    fbb_.AddOffset(YWW::VT_WEAPONS, weapons);
  }
  void add_equipped_type(MyGame::Sample::Equipment equipped_type) {
    fbb_.AddElement<uint8_t>(YWW::VT_EQUIPPED_TYPE, static_cast<uint8_t>(equipped_type), 0);
  }
  void add_equipped(::flatbuffers::Offset<void> equipped) {
    fbb_.AddOffset(YWW::VT_EQUIPPED, equipped);
  }
  void add_path(::flatbuffers::Offset<::flatbuffers::Vector<const MyGame::Sample::Vec3 *>> path) {
    fbb_.AddOffset(YWW::VT_PATH, path);
  }
  explicit YWWBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<YWW> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<YWW>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<YWW> CreateYWW(
...
inline ::flatbuffers::Offset<YWW> CreateYWWDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const MyGame::Sample::Vec3 *pos = nullptr,
    int16_t mana = 150,
    int16_t hp = 100,
  ...
  return MyGame::Sample::CreateYWW(
      _fbb,
      pos,
      mana,
      hp,
...
inline const MyGame::Sample::YWW *GetYWW(const void *buf) {
  return ::flatbuffers::GetRoot<MyGame::Sample::YWW>(buf);
}

inline const MyGame::Sample::YWW *GetSizePrefixedYWW(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<MyGame::Sample::YWW>(buf);
}

inline bool VerifyYWWBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MyGame::Sample::YWW>(nullptr);
}

inline bool VerifySizePrefixedYWWBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MyGame::Sample::YWW>(nullptr);
}

inline void FinishYWWBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MyGame::Sample::YWW> root) {
  fbb.Finish(root);
}

inline void FinishSizePrefixedYWWBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<MyGame::Sample::YWW> root) {
...
#endif  // FLATBUFFERS_GENERATED_YWW_MYGAME_SAMPLE_H_
